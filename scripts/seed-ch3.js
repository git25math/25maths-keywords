...
add('cie', '3.1', 'knowledge', {
  ...
  content_zh:
    '<b>知识回顾</b><br>' +
    '• <b>笛卡尔平面</b>：水平 $x$ 轴和垂直 $y$ 轴，交于<b>原点</b> $(0,0)$。<br>' +
    '• 点写作 $(x, y)$，$x$ 坐标在前。<br>' +
    '• 四个象限：Q1 $(+,+)$, Q2 $(-,+)$, Q3 $(-,-)$, Q4 $(+,-)$。'
});
...
add('cie', '3.3', 'examples', {
  ...
  content_zh:
    '<b>经典例题</b> [2 分]<br>' +
    '求过 $(2,5)$ 和 $(8,-1)$ 的直线斜率。<br><br>' +
    '<b>解答：</b>$m = \\frac{-1-5}{8-2} = -1$'
});
...
add('cie', '3.4', 'knowledge', {
  ...
  content_zh:
    '<b>知识回顾</b><br>' +
    '• <b>两点距离</b>：$d = \\sqrt{(x_2-x_1)^2 + (y_2-y_1)^2}$。<br>' +
    '• <b>中点</b>：$M = \\left(\\frac{x_1+x_2}{2}, \\frac{y_1+y_2}{2}\\right)$。<br><br>' +
    '<b>考试技巧</b><br>' +
    '题目要求"精确值"时用根式表示。'
});
...
add('cie', '3.7', 'knowledge', {
  ...
  content_zh:
    ...
    '<b>知识回顾</b><br>' +
    '• <b>垂直线</b>成 90°。<br>' +
    '• 斜率 $m$ 的垂直线斜率为 $-\\frac{1}{m}$。<br>' +
    '• 垂直线斜率之积 = $-1$。<br>' +
    '• <b>垂直平分线</b>：过中点且斜率为负倒数。<br><br>' +
    '<b>注意！</b><br>' +
    '$\\frac{2}{3}$ 的负倒数是 $-\\frac{3}{2}$，不是 $-\\frac{2}{3}$。'
});
...
add('cie', '3.7', 'examples', {
  ...
  content_zh:
    '<b>经典例题</b> [3 分]<br>' +
    '直线 $L$ 过 $A(1,4)$ 和 $B(5,2)$，求 $AB$ 的垂直平分线方程。<br><br>' +
    '<b>解答：</b>中点 $(3,3)$，$AB$ 斜率 $-\\frac{1}{2}$，垂直斜率 $2$<br>' +
    '$y - 3 = 2(x-3)$，$y = 2x - 3$'
});
...
add('edexcel', '3.1', 'knowledge', {
  ...
  content_zh:
    '<b>知识回顾</b><br>' +
    '• <b>等差数列</b>：公差 $d$ 恒定，$T_n = dn + (a-d)$。<br><br>' +
    '<b>仅 Higher</b><br>' +
    '• <b>二次数列</b>：二阶差恒定，$T_n = an^2 + bn + c$。<br>' +
    '• <b>等比数列</b>：公比 $r$，$T_n = ar^{n-1}$。<br><br>' +
    '<b>考试技巧</b><br>' +
    '用 $n = 1, 2, 3$ 代入检验公式。'
});
...
add('edexcel', '3.3', 'knowledge', {
  ...
  content_zh:
    '<b>知识回顾</b><br>' +
    '• 一次、二次、三次、反比例函数图像。<br><br>' +
    '<b>仅 Higher</b><br>' +
    '• 指数函数、三角函数图像。<br>' +
    '• 图像变换：$f(x)+a$ 上移，$f(x+a)$ 左移，$af(x)$ 纵向拉伸，$f(ax)$ 横向压缩。<br>' +
    '• 画切线求斜率。'
});
...
add('edexcel', '3.3', 'examples', {
  ...
  content_zh:
    '<b>经典例题</b> [4 分]<br>' +
    '$y = f(x)$ 最大值在 $(2,5)$，求下列函数最大值坐标：<br>' +
    '(a) $y = f(x)+3$ (b) $y = f(x-4)$ (c) $y = -f(x)$<br><br>' +
    '<b>解答：</b>(a) $(2, 8)$<br>(b) $(6, 5)$<br>(c) $(2, -5)$（变为最小值）'
});
...
add('edexcel', '3.4', 'knowledge', {
  ...
  content_zh:
    '<b>仅 Higher</b><br><br>' +
    '<b>知识回顾</b><br>' +
    '• $y = ax^n$ → $\\frac{dy}{dx} = anx^{n-1}$。<br>' +
    '• 转折点：令 $\\frac{dy}{dx} = 0$。<br>' +
    '• $\\frac{d^2y}{dx^2} > 0$ 最小值；$< 0$ 最大值。<br><br>' +
    '<b>考试技巧</b><br>' +
    '求切线方程：先求该点斜率 $m$，再用点斜式。'
});
...
add('edexcel', '3.4', 'examples', {
  ...
  content_zh:
    '<b>经典例题</b> [5 分]<br>' +
    '求 $y = x^3 - 6x^2 + 9x + 2$ 的转折点并判断性质。<br><br>' +
    '<b>解答：</b>$\\frac{dy}{dx} = 3(x-1)(x-3) = 0$<br>' +
    '$x = 1$：最大值 $(1, 6)$；$x = 3$：最小值 $(3, 2)$。'
});
