...
add('cie', '4.1', 'knowledge', {
  ...
  content_zh:
    '<b>知识回顾</b><br>' +
    '• <b>点</b>没有大小。<b>直线</b>向两个方向无限延伸。<b>线段</b>有两个端点。<br>' +
    '• <b>射线</b>从一个点开始并向一个方向无限延伸。<br>' +
    '• <b>平行线</b> ($\\parallel$) 永不相交。<b>垂直线</b> ($\\perp$) 以 $90°$ 相交。<br>' +
    '• <b>角类型</b>：锐角 ($< 90°$)、直角 ($= 90°$)、钝角 ($90° < \\theta < 180°$)、优角 ($> 180°$)。<br>' +
    '• <b>多边形</b>：由直线段围成的封闭二维图形。<b>正多边形</b>：所有边和角都相等。<br>' +
    '• <b>对角线</b>：连接两个不相邻顶点的线段。<br>' +
    '<br>' +
    '<b>关键技能</b><br>' +
    '• 识别并命名三角形类型（不等边三角形、等腰三角形、等边三角形、直角三角形）。<br>' +
    '• 识别四边形及其性质（正方形、长方形、平行四边形、菱形、梯形、筝形）。<br>' +
    '• 使用正确的符号：$\\overline{AB}$ 表示线段，$\\angle ABC$ 表示角。<br>' +
    '<br>' +
    '<b>考试技巧</b><br>' +
    '了解每种特殊四边形的性质——考官经常考查"哪种形状恰好有一组平行边？"（梯形）。'
});
...
add('cie', '4.2', 'knowledge', {
  ...
  content_zh:
    '<b>知识回顾</b><br>' +
    '• <b>仅使用直尺和圆规</b>——不要擦除作图痕迹（弧线）。<br>' +
    '• $AB$ 的<b>垂直平分线</b>：设置圆规半径大于 $AB$ 的一半，分别从 $A$ 和 $B$ 画弧，连接交点。<br>' +
    '• <b>角平分线</b>：从顶点画弧切割角的两条边，然后从这两个交点画弧，连接顶点和交点。<br>' +
    '• <b>过一点作直线的垂线</b>：从该点画弧在直线上切割出两点，然后作这两点的垂直平分线。<br>' +
    '<br>' +
    '<b>关键技能</b><br>' +
    '• 根据 SSS、SAS 或 ASA 作三角形。<br>' +
    '• 作 $60°$ 角（等边三角形作法）。<br>' +
    '• 作 $90°$ 角（垂直平分线）。<br>' +
    '<br>' +
    '<b>注意！</b><br>' +
    '务必保留作图痕迹。阅卷老师需要看到它们才能给分。'
});
...
add('cie', '4.3', 'knowledge', {
  ...
  content_zh:
    '<b>知识回顾</b><br>' +
    '• <b>比例图</b>使用比例，例如 $1 : 20\\,000$ 表示地图上的 1 cm = 现实生活中的 $20\\,000$ cm = 200 m。<br>' +
    '• <b>方位角</b>是从<b>正北</b>方向顺时针测量的，通常写成<b>三位数字</b>：例如 $045°$，$210°$，$008°$。<br>' +
    '<br>' +
    '<b>关键技能</b><br>' +
    '• 使用比例尺在地图距离和实际距离之间进行转换。<br>' +
    '• 使用量角器测量并绘制方位角。<br>' +
    '• 寻找<b>反方位角</b>：加上或减去 $180°$。<br>' +
    '<br>' +
    '<b>注意！</b><br>' +
    '方位角总是"从" (FROM) 某一点出发。"$B$ 从 $A$ 出发的方位角"意味着站在 $A$ 点并测量到 $B$ 的角度。'
});
...
add('cie', '4.4', 'knowledge', {
  ...
  content_zh:
    '<b>知识回顾</b><br>' +
    '• <b>全等</b>图形的形状和大小完全相同。判定方法：SSS, SAS, ASA, RHS。<br>' +
    '• <b>相似</b>图形形状相同但大小不同。对应角相等；对应边成比例。<br>' +
    '• <b>比例系数</b> $k$：如果长度缩放倍数为 $k$，那么面积缩放倍数为 $k^2$，体积缩放倍数为 $k^3$。<br>' +
    '<br>' +
    '<b>关键技能</b><br>' +
    '• 证明两个三角形相似（AA，SSS 比例，或 SAS 比例）。<br>' +
    '• 使用比例系数求缺失的长度、面积和体积。<br>' +
    '• 面积比 $= \\left(\\frac{l_1}{l_2}\\right)^2$。体积比 $= \\left(\\frac{l_1}{l_2}\\right)^3$。<br>' +
    '<br>' +
    '<b>注意！</b><br>' +
    '确保匹配<b>对应</b>边。按正确的顺序书写三角形：$\\triangle ABC \\sim \\triangle DEF$ 意味着 $A \\leftrightarrow D$，$B \\leftrightarrow E$，$C \\leftrightarrow F$。'
});
...
add('cie', '4.5', 'knowledge', {
  ...
  content_zh:
    '<b>知识回顾</b><br>' +
    '• <b>轴对称</b>：一条镜像线（对称轴）将图形分为完全相同的两半。<br>' +
    '• <b>旋转对称</b>：图形在旋转小于 $360°$ 后看起来仍然相同。<b>阶</b> (order) 是指在一个全转中匹配的次数。<br>' +
    '• 具有 $n$ 条边的正多边形：有 $n$ 条对称轴，旋转对称的阶为 $n$。<br>' +
    '• 圆有无数条对称轴。<br>' +
    '<br>' +
    '<b>关键技能</b><br>' +
    '• 在图形上画出对称轴。<br>' +
...
add('cie', '4.7', 'knowledge', {
  ...
  content_zh:
    '<b>知识回顾</b><br>' +
    '• <b>圆的各部分</b>：半径 (radius)、直径 (diameter)、弦 (chord)、弧 (arc)、扇形 (sector)、弓形 (segment)、切线 (tangent)、割线 (secant)。<br>' +
    '• <b>圆心角</b>是<b>圆周角</b>的两倍（同弧所对）。<br>' +
    '• <b>半圆</b>上的圆周角 $= 90°$。<br>' +
    '• <b>同弧所对的圆周角</b>（同弓形内的角）相等。<br>' +
    '• <b>圆内接四边形</b>的<b>对角</b>之和为 $180°$。<br>' +
    '• <b>切线</b>在切点处垂直于半径。<br>' +
    '• 从圆外一点引出的<b>两条切线</b>长度相等。<br>' +
    '• <b>弦切角定理</b>：切线与弦之间的夹角等于交错弓形内的角。<br>' +
    '<br>' +
    '<b>考试技巧</b><br>' +
    '学习每个定理的准确措辞 —— 正确的数学语言会给分。'
});
...
add('cie', '4.8', 'knowledge', {
  ...
  content_zh:
    '<b>知识回顾</b><br>' +
    '• <b>轨迹</b>是满足某个条件的所有点的集合。<br>' +
    '• 与一个<b>点</b>等距离的轨迹 → <b>圆</b>。<br>' +
    '• 与一条<b>直线</b>等距离的轨迹 → <b>一对平行线</b>。<br>' +
    '• 与<b>两个点</b>等距离的轨迹 → <b>垂直平分线</b>。<br>' +
    '• 与<b>两条直线</b>等距离的轨迹 → <b>角平分线</b>。<br>' +
    '<br>' +
    '<b>关键技能</b><br>' +
    '• 结合多个轨迹来确定一个区域（通常是阴影部分）。<br>' +
    '• "距离 $A$ 点 3 cm 以内" → 以 $A$ 为圆心，半径为 3 cm 的圆。<br>' +
    '• "离 $AB$ 比离 $AC$ 更近" → $\\angle BAC$ 的角平分线。<br>' +
    '• "离 $A$ 比离 $B$ 更近" → $AB$ 的垂直平分线。<br>' +
    '<br>' +
    '<b>考试技巧</b><br>' +
    '阅读每一个条件。答案通常是两个或多个轨迹的交集。'
});
